...
int main() {
  // Create two players with their names 
   ...
   game.printLastTurn(); // print the last turn stats. For example:
                                                    ...
                                                    // Alice played 6 of Hearts Bob played 6 of Spades. Dmraw. Alice played 10 of Clubs Bob played 10 of Diamonds. draw. Alice played Jack of Clubs Bob played King of Diamonds. Bob wins.
